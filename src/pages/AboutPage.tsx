...
const teamMembers = [
  { 
    name: "Lawrence Attoh", 
    role: "Founder & CEO",
    description: "Visionary leader with expertise in AI, software, and business strategy.",
    img: LawrenceAttoh 
  },
  { 
    name: "Zohaib Shaikh", 
    role: "Lead Software Engineer & AI Specialist",
    description: "Expert in AI and full-stack development, driving technical innovation.",
    img: ZohaibShaikh 
  }
];
    ...
    <main className="bg-white w-full">
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="w-full md:w-1/2">
          ...
          <ul className="mt-6 space-y-4 text-lg text-[#442F0D]">
            <li>✔ <strong>User-Centric Approach</strong> – We prioritize intuitive, functional, and scalable designs.</li>
            <li>✔ <strong>Future-Ready Solutions</strong> – Leveraging AI, BCI, and advanced tech to stay ahead.</li>
            <li>✔ <strong>Collaborative Partnership</strong> – Your vision + our expertise = extraordinary results.</li>
            <li>✔ <strong>Proven Impact</strong> – A portfolio of successful projects across industries.</li>
          </ul>
          <p className="mt-4 text-[#442F0D]">Let’s build something groundbreaking together. 🚀</p>
        </div>
      </section>
      ...
      <section className="w-full bg-[#FCFBFA]">
        <section className="py-16 px-6 max-w-7xl mx-auto">
          <h2 className="text-3xl font-extrabold text-gray-900 text-center">Meet the Leadership Team</h2>
          <p className="text-lg text-gray-600 text-center mt-2">
            A diverse team of innovators, engineers, and strategists shaping the future of technology.
          </p>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="bg-white p-4 text-center">
                  ...
                  <p className="text-sm font-medium text-[#442F0D]">{member.role}</p>
                  <p className="text-gray-600 mt-1 text-xs leading-relaxed">{member.description}</p>
                </div>
              </div>
            ))}
          </div>
